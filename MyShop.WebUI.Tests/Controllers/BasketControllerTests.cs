...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        [TestMethod]
        public void CanAddBasketItemUsingController()
        {
            //setup
            IRepository<Basket> baskets = new MockContext<Basket>();
            IRepository<Product> products = new MockContext<Product>();
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "philip.bedi@gmail.com", ZipCode = "90210" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("philip.bedi@gmail.com", "Forms"), null);
